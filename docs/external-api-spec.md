...
> - `28110`(인천 중구)이 0인 것은 해당 시군구의 연립다세대 거래가 **실제로 없어서**일 가능성이 있다.
>   전남·광주처럼 전면 결측인지는 **[미확인]** — 다른 월/연도로 확인하지 않았다.
...
| 21 | `28110`(인천 중구) RHRent 0건이 전면 결측인지 실제 무거래인지 | 202606 1개월만 확인 (4.6절) |
