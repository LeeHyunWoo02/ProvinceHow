package SDD.smash.job.application;
...
import SDD.smash.job.application.dto.JobCategoryView;
import SDD.smash.job.application.dto.JobInfo;
...
import SDD.smash.job.domain.port.JobCountRepository;
import SDD.smash.job.domain.port.JobListingLinkProvider;
...
/**
 * 일자리 조회 유스케이스. As-Is {@code JobService} 와 {@code CodeService} 의 직종 부분을 옮긴 것이다.
 *
...
public class JobQueryService implements JobQueryUseCase {
